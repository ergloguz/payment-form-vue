<template>
  ...
  <div class="payment">
    <div class="payment-tabs"><a href="javascript:void(0);">Cart</a><a href="javascript:void(0);">Customer
      Information</a><a href="javascript:void(0);">Shipping</a><a class="active" href="javascript:void(0);">Payment</a>
    </div>
    ...
    <div class="payment-method">
      ...
      <div class="pm-item">
        ...
        <label class="pm-label" for="mcc">
          <div class="pm-text">
            <h5>Credit Card</h5>
            <p>Safe money transfer using your bank account. Safe payment online. Credit card needed. Visa, Maestro,
    ...
    <b-form @submit.stop.prevent="onSubmit" class="payment-input">
      ...
      <button type="submit">fdsdfsd</button>
    </b-form>
    <div class="payment-actions"><a class="return" href="javascript:void(0);">Return to Shipping</a><a class="finish"
                                                                                                       href="javascript:void(0);">Finish
      Order <img class="ml-2"
                 src="data:image/png;base64,"/></a>
    </div>
  </div>
</template>
